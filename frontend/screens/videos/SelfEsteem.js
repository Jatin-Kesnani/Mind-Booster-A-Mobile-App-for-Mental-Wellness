...
export default function SelfEsteem() {
    ...
    async function getSelfEsteemVideos() {
        const { data, error } = await supabase
            .storage
            .from('videos')
            .list('Self-Esteem', { limit: 10, offset: 0 });
        ...
        if (error) {
            ...
            const videoUrls = data.map((file) => ({
                ...
                url: supabase.storage
                    .from('videos')
                    .getPublicUrl(`Self-Esteem/${file.name}`).data.publicUrl,
            }));
    ...
    return (
        ...
        >
            <SafeAreaView style={styles.container}>
                ...
                {/* <ScrollView> */}
                    <Text style={styles.heading}>Self-Esteem</Text>
                    <FlatList
                        data={videos}
